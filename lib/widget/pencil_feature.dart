...
///
// class PencilSettings extends StatelessWidget {
//   @override
//   Widget build(BuildContext context) {
//     return Container(
...
//               Expanded(
//                 child: Slider(
//                   value: context.watch<SketchProvider>().strokeWidth,
//                   min: 1.0,
//                   max: 10.0,
//                   onChanged: (value) {
//                     context.read<SketchProvider>().setStrokeWidth(value);
//                   },
//                 ),
//               ),
//             ],
...
//                   context.read<SketchProvider>().showColorPicker(context);
//                 },
//               ),
//             ],
//           ),
...
//                       context
//                           .read<SketchProvider>()
//                           .setPencilColor(Colors.primaries[index]);
//                     },
//                     child: Container(
//                       width: 24,
//                       height: 24,
